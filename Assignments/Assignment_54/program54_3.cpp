...
// Output        : Returns sum of all odd elements
// Description   : Calculates and returns the sum of odd numbers in the array
...
void MainX()
{
    ...
    Ans=SumOdd(Arr,iSize);
    cout<<"The sum of all odd elements is :"<<Ans<<"\n";
